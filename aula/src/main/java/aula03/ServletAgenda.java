...
public class ServletAgenda extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String get_datanasc=request.getParameter("datanasc");
		
		writer.println("<h1>Dados registrados com sucesso!</h1>");
		writer.println("<h3>Seus dados:</h3>");
		writer.println(get_name);
		writer.println("<br>");
		writer.println(get_telefone);
		writer.println("<br>");
		writer.println(get_datanasc);
